...
# System Properties
$(call inherit-product, device/xiaomi/ido-common/system_prop.mk)
ifeq ($(TARGET_BOARD_PLATFORM_VARIANT),msm8939)
$(call inherit-product, device/xiaomi/ido-common/system_prop_msm8939.mk)
else ifeq ($(TARGET_BOARD_PLATFORM_VARIANT),msm8916)
$(call inherit-product, device/xiaomi/ido-common/system_prop_msm8916.mk)
endif
